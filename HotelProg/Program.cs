...
namespace HotelProgram
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            HotelRoom room1 = new HotelRoom(101, RoomStyle.TwinRoom, true, 1500);
            HotelRoom room2 = new HotelRoom(102, RoomStyle.KingRoom, true, 3000);
            ...
            HotelRoom hotel456Room1 = new HotelRoom(101, RoomStyle.QueenRoom, true, 2000);
            HotelRoom hotel456Room2 = new HotelRoom(102, RoomStyle.QueenRoom, true, 2000);
